...
ROOT_URLCONF = 'electicsmerchandise.urls'
...
WSGI_APPLICATION = 'electicsmerchandise.wsgi.application'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [os.path.join(BASE_DIR, 'electicsmerchandise/static')]
